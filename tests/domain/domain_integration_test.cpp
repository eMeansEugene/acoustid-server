//
// Интеграционные тесты для доменных сервисов (IndexingService, MatchingService).
//
...
// ---- Вспомогательные функции для построения синтетического WAV ----------------------------
